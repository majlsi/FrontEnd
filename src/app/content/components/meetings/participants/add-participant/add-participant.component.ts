...
export class AddParticipantComponent implements OnInit {
    ...
    getSearchForUsers(userName) {
		this._userService.getMeetingCommitteeUsers({name: userName}, this.meetingId).subscribe(data => {
			const res = data[0].meeting_committee.member_users;
